          ...
          <div className="container mx-auto px-4 py-24 md:py-28 min-h-screen flex flex-col">
            <div className="absolute top-4 right-4 z-20 flex flex-col gap-2">
              ...
              <Button
                ...
                className={`relative flex items-center gap-2 transition-all duration-300 overflow-hidden ${
                  isDarkMode 
              ...
              >
                {isMusicEnabled ? (
                  <>
                    <Volume2 className={`w-4 h-4 text-green-600 ${isTransitioning ? 'animate-pulse' : ''}`} />
                    <span className="font-medium">Music On</span>
                  </>
                ) : (
                  <>
                    <VolumeX className="w-4 h-4 text-red-600" />
                    <span className="font-medium">Music Off</span>
                  </>
                )}
            ...
            <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-20">
              <p className="text-lg text-center retro-crt text-white/90">
